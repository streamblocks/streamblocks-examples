...
$(ENTITY_NETWORK)_HLS_SYSTEMC:
	$(SB_BIN) vivado-hls $(SYSTEMC_SETTIGNS) $(HLS_SETTINGS) $(PATH_SETTINGS) $(ENTITY)

$(ENTITY_NETWORK)_MULTICORE_SYSTEMC:
	$(SB_BIN) multicore $(SYSTEMC_SETTIGNS) $(MULTICORE_SETTIGS) $(PATH_SETTINGS) $(ENTITY)

$(ENTITY_NETWORK)_SYSTEMC: $(ENTITY_NETWORK)_MULTICORE_SYSTEMC $(ENTITY_NETWORK)_HLS_SYSTEMC
	cd $(TARGET_PATH); \
	mkdir -p build; \
	cd build; \
	$(CMAKE) .. -DCMAKE_BUILD_TYPE=Release -DUSE_SYSTEMC=on -DHLS_CLOCK_PERIOD=$(HLS_CLOCK_PERIOD); \
